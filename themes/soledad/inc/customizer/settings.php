...
function pencidesign_register_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_setting( 'penci_add_hatom_data', array(
		'default'           => false,
		'sanitize_callback' => 'penci_sanitize_checkbox_field'
	) );
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'add_hatom_data', array(
		'label'    => 'Add Hatom Data Markup',
		'section'  => 'pencidesign_new_section_general',
		'settings' => 'penci_add_hatom_data',
		'type'     => 'checkbox',
		'priority' => 60
	) ) );
